...
// list all movies. If the req has "is_showing" as param, it returns only the movies that are currently showing
...
// Func read to return all theaters where the movie from a given movieId is being played
